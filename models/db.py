...
class Pattern(Base):
    ...
    channels: Mapped[list["Channel"]] = relationship(
        "Channel", back_populates="pattern", cascade="all, delete-orphan",
        order_by="Channel.id"
    )
...
class Channel(Base):
    ...
    steps: Mapped[list["Step"]] = relationship(
        "Step", back_populates="channel", cascade="all, delete-orphan",
...
class Step(Base):
    ...
    pitch: Mapped[int] = mapped_column(Integer, default=60)
    velocity: Mapped[int] = mapped_column(Integer, default=100)
